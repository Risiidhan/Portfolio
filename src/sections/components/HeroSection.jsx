  ...
  return (
    <>
      <motion.div
        ...
        className="content-section md:my-12 grid grid-cols-2 gap-4">
        <div className='md:col-span-1 col-span-2 md:order-1 order-2 grid place-items-center'>
          <div className="grid place-content-center">
            <span className='text-3xl md:text-4xl mb-1 font-semibold tracking-widest'>Hi,</span>
            <p className='text-3xl md:text-4xl mb-5 font-semibold tracking-widest'>I'm Risiidhan Punniymoorthy</p>
